  ...
  const sortedAndFilteredContacts = useMemo(() => {
    ...
    const sorted = filtered.sort((a, b) => {
      ...
      if (sortField === "connectionStrength") {
        ...
        aVal = strengthMap[aVal];
        bVal = strengthMap[bVal];
      }
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="relative">
            <button
              ...
              Filter
              {filterStrength && <span
                className="ml-1 text-xs bg-primary text-primary-foreground rounded-sm px-1.5 py-0.5">1</span>}
            </button>
                ...
                {paginatedContacts.map((contact) => (
                  <motion.div key={contact.id} variants={shouldAnimate ? rowVariants : {}}>
                    <div
                      ...
                      <div
                        className="flex items-center gap-2 min-w-0 border-r border-border/20 px-3">
                        <div
                          className="inline-flex items-center gap-2 px-2 py-1 bg-muted/30 rounded-full">
                          <svg
                            width="14"
                            height="14"
                            viewBox="0 0 16 16"
                      ...
                      <div className="flex items-center border-r border-border/20 px-3">
                        {(() => {
                          ...
                          return (
                            <div
                              className={`inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium ${bgColor} ${textColor} rounded-md`}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {(() => {
                        ...
                        return (
                          <div
                            className={`inline-flex items-center gap-1.5 px-2 py-0.5 text-xs font-medium ${bgColor} ${textColor} rounded-md mt-1`}>
